!***************************************************************************************************
!- PURPORSE:
!     CALCULATE STRESSES AT NODAL POINTS FOR 3 AND 6 NODE TRIANGULAR ELEMENTS.
!  
!- INPUT ARGUMENTS:
...
SUBROUTINE STRESS_NODAL_TRIANGLE(I_ELEMENT, NUM_ELE_NODE, ADJ_ELE, TP)

USE SOLUTION_DATA, ONLY: INT_KIND, REAL_KIND, WORD_KIND, NUM_NODE, ELEMENT_LIB, ELEMENTS, MATERIALS, &
                         INTE_STRAIN, NODAL_STRESS
...
!-- THE STRESS IS CONSTANT OVER THE 3-NODE TRIANGULAR ELEMENT --
IF(NUM_ELE_NODE .EQ. 3) THEN
   DO I = 1, NUM_ELE_NODE
      J = ELEMENTS(I_ELEMENT)%NODE(I)
      NODAL_STRESS(J)%VALUE = NODAL_STRESS(J)%VALUE + MATMUL(D, INTE_STRAIN(I_ELEMENT)%VALUE)
...
END SUBROUTINE STRESS_NODAL_TRIANGLE